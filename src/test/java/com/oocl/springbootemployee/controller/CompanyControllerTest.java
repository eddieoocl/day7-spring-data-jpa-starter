...
class CompanyControllerTest {
    ...
    private void setUpCompanyRepository() {
        ...
        acme_corporation = new Company("Acme Corporation", List.of(john_smith, jane_johnson));
        techcom_solutions = new Company("TechCom Solutions", List.of(david_williams, emily_brown, michael_jones));
        global_innovators = new Company("Global Innovators");
        stellar_enterprises = new Company("Stellar Enterprises");
        nexus_industries = new Company("Nexus Industries");

        companyRepository.save(acme_corporation);
        companyRepository.save(techcom_solutions);
        companyRepository.save(global_innovators);
        companyRepository.save(stellar_enterprises);
